...
$main->set('feedattr_default',array('title','description','color', 'dark', 'light','formats','flattrid','author','summary','image','keywords','category','email','language','explicit','itunes','disqus','auphonic-path','auphonic-glob','auphonic-url','auphonic-mode','twitter','adn','itunesblock','mediabaseurl','mediabasepath','redirect','bitlove','cloneurl','clonepath','licenseurl','licensename','rfc5005','pagedcount','baseurl','adntoken','feedalias'));

$main->set('itemattr',array('title','description','link','guid','article','payment','chapters','banner','enclosure','duration','keywords','image','date','noaudio','adnthread'));
